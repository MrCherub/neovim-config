...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sl', '<cmd>Lazy<cr>', { desc = '[S]earch [L]azy' })
    ...
    config = function()
      ...
      cmp.setup {
        ...
        sources = {
          ...
          { name = 'path' },
          { name = 'buffer' },
          -- { name = 'omni' }, -- disabled: slows down nvim
        },
      }
    end,
  },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('FileType', {
        ...
        callback = function(args)
          ...
          -- Check if the parser exists before enabling treesitter features for the buffer.
...
vim.keymap.set('n', ',lc', ':cclose<CR>', {
  silent = true,
  desc = 'Close LaTeX compiler (quickfix)',
})
